...
generator = mlrose_hiive.ContinuousPeaksGenerator()
problems = []
for i in range(30): # GA DID BEST
    problem = generator.generate(seed=i, size=100, t_pct=.1)
...
plt.title("Continuous Peaks Fitness vs Iterations")
plt.xlabel("Iterations")
plt.ylabel("Fitness")
plt.legend()
plt.savefig("cp_plt.png")

#for sa_run in sa_vals:
